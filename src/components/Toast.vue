      ...
      <Transition name="toast">
        ...
        >
          ...
          <span v-if="icon" class="mr-2">
            ...
            <svg v-else-if="type === 'info'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          <!-- Bouton de fermeture -->
          <button v-if="dismissible" @click="close" class="ml-2 text-white opacity-70 hover:opacity-100">
